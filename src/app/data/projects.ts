...
export const projects: ProjectItem[] = [
	{
		...
		description: "This is an MEAN stack project that uses the Sleeper App API to display live data and charts on your favorite Sleeper fantasy league. If you have a league ID enter it in the field, if not feel free to use 725424222041657344 as an example.",
